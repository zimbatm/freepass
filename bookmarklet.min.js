...
a.value=s;n.push({a:a,b:b})}}}function x(){for(var a;a=n.pop();)a.a.style.cssText=a.b}function v(a){j("gotev",a,z);if(a.origin===z)if(a.data==="hello"){a.source.postMessage("world",a.origin);j("Handshake done, waiting for password");p=a.source}else{a=JSON.parse(a.data);if(a.hasOwnProperty("password")){s=a.password;j("Got password",s);c.style.backgroundColor=y;if(r)x();else{d.addEventListener("dblclick",w,true);r=true}}else j("why ??? (bug)",a)}}var d=e.document,u="<?php echo $base_url; ?>",z="<?php echo $base_domain; ?>",
A="fp<?php echo sha1(time()+1); ?>",y="#ddffdd",n=[],r=false,f,p,c,o,g,s;if(!e||!e.document)e.location=u;else if(!document.getElementById("fp<?php echo sha1(time()); ?>")){c=d.createElement("div");c.id="fp<?php echo sha1(time()); ?>";l(c.style,{padding:0,margin:0,border:"1px solid #aaaaaa",font:"normal 12px",fontFamily:"Trebuchet MS, Helvetica, Arial, sans-serif",textAlign:"right",position:"fixed",top:"10px",left:"10px",color:"#333333",background:"#99aabb",zIndex:"1000000"});c.addEventListener("mousedown",
C,false);o=d.createElement("span");l(o.style,{marginLeft:"2em",marginRight:"2em"});o.innerHTML="FreePass";g=d.createElement("input");l(g.style,{margin:0,padding:0,border:0,color:"inherit",background:"inherit",font:"inherit",borderRight:"1px solid #aaaaaa"});g.type="button";g.value="x";g.addEventListener("click",D,false);c.appendChild(g);c.appendChild(o);d.body.appendChild(c);e.addEventListener("message",v,false);t()}})(this);
